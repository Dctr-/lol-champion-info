...
public class ImageManager {
     ...
     *
     * @param fileName the fileName matching the fileName from {@link ImageManager#queueImageDownload(java.lang.String, java.lang.String, int, int)}
     ...
     *
     * @param url      the url matching an image to be downloaded
     * @param fileName the name the file will be saved locally under, without extension
